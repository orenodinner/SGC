...
- `spec/portable-artifact-contract.json` を required path と配布方針の契約にし、build script と unit test の両方から参照する。
- regression hardening は既存 smoke の追加ではなく、project persistence / settings persistence / backup preview / Excel export をまたぐ desktop journey を1本追加する。
